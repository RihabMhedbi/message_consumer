...
class ConsumerAPITests(TestCase):
    """Test cases for the consumer app API."""
    ...
    def test_message_processing_view(self, mock_process_message):
        """Test the message processing view."""
        ...
        # Check if the task ID is returned to the response
    ...
    def test_result_endpoint(self):
        ...
        TaskResult.objects.create(
            task_id='776bc5d4-0182-4f85-a566-78c7adf5e29a',
            result='Processed result'
        )
        url = f'/api/task_result/'
        basic_auth = 'Basic ' + base64.b64encode(
            f"{self.username}:{self.password}".encode()).decode('utf-8')
